...
# model path
model_name          = "/gemini/code/models/Wan2.2-VACE-Fun-A14B"
...
control_video       = None
start_image         = "/gemini/code/VideoX-Fun/IP_benchmark/hellokitty.PNG"
end_image           = None
# Use inpaint video instead of start image and end image.
inpaint_video       = None
inpaint_video_mask  = None
subject_ref_images  = ["/gemini/code/VideoX-Fun/IP_benchmark/laughing_kitty.png"]
...
prompt                  = "The character is laughing. The character's eyes slightly curve like upside-down U shapes, Keep the original character design and do not add any mouth, lips, teeth, or tongue on the face."
negative_prompt         = ""
