...
if __name__ == "__main__":
    ...
    if ui_mode == "host":
        from videox_fun.ui.wan2_2_fun_ui import Wan2_2_Fun_Controller_Host
        controller = Wan2_2_Fun_Controller_Host(
            GPU_memory_mode, flow_scheduler_dict, model_name=model_name, model_type=model_type, 
        ...
        demo, _ = ui_host(GPU_memory_mode, flow_scheduler_dict, model_name, model_type, config_path, compile_dit, weight_dtype)
        ...
        controller = Wan2_2_Fun_Controller(
            GPU_memory_mode, flow_scheduler_dict, model_name=None, model_type="Inpaint", 
            config_path=config_path, ulysses_degree=ulysses_degree, ring_degree=ring_degree,
            fsdp_dit=fsdp_dit, fsdp_text_encoder=fsdp_text_encoder, compile_dit=compile_dit, 
            weight_dtype=weight_dtype
        )
        demo, _ = ui(GPU_memory_mode, flow_scheduler_dict, config_path, compile_dit, weight_dtype)
        demo.controller = controller
