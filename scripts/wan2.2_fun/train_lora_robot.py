...
def main():
    ...
    if str(args.dataset_type).lower() == "robot":
        # Robot video dataset for LIBERO perturbed data
        train_dataset = RobotVideoDataset(
            ...
            suites=["libero_90","libero_10", "libero_goal", "libero_object", "libero_spatial"],
        )
    ...
    if args.enable_bucket:
        ...
        def collate_fn(examples):
            ...
            for example in examples:
                ...
                if args.train_mode != "normal":
                    mask = get_random_mask_for_edit(new_examples["pixel_values"][-1].size())
