...
LORA_PATH=${LORA_PATH:-/gemini/code/VideoX-Fun/output_dir_moviebench_firstframe_pair_5b_whithout_white_frame_seg/checkpoint-9000.safetensors}
LORA_WEIGHT=${LORA_WEIGHT:-1}

OUTPUT_DIR=${OUTPUT_DIR:-/gemini/code/VideoX-Fun/examples/wan2.2_fun/firstframe_pair_val_outputs_2.2fun_5b_without_white_frame_9000_seg}
...
if [ -n "${LORA_PATH}" ]; then
  ${RUNNER} /gemini/code/VideoX-Fun/examples/wan2.2_fun/predict_i2v_5b_firstframe_pair_val_seg.py \
