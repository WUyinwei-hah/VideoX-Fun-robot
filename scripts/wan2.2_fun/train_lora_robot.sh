...
accelerate launch --mixed_precision="bf16" --num_processes 8 --num_machines 1 ${PROJECT_ROOT}/scripts/wan2.2_fun/train_lora_robot.py \
  ...
  --learning_rate=1e-04 \
  --seed=42 \
  --output_dir="/gemini/code/VideoX-Fun/output_dir_robot_libero" \
