...
EVAL_JSONL_PATH=${EVAL_JSONL_PATH:-/gemini/code/VideoX-Fun/examples/wan2.2/moviebench_firstframe_pair_test.jsonl}
EVAL_NUM_SAMPLES=${EVAL_NUM_SAMPLES:-8}
EVAL_SEED=${EVAL_SEED:-42}

DEFAULT_CONFIG_PATH=/gemini/code/VideoX-Fun/config/wan2.2/wan_civitai_5b.yaml
DEFAULT_MODEL_NAME=/gemini/code/models/Wan2.2-Fun-5B-InP
DEFAULT_LORA_PATH="/gemini/code/VideoX-Fun/output_dir_moviebench_firstframe_pair_5b_2.2fun/checkpoint-1500.safetensors"
...
OUTPUT_DIR=${OUTPUT_DIR:-/gemini/code/VideoX-Fun/examples/wan2.2/character_firstframe_5b_outputs_2.2fun}
...
if [ -n "${LORA_PATH}" ]; then
  ${RUNNER} /gemini/code/VideoX-Fun/examples/wan2.2/predict_ti2v_firstframe_pair_val.py \
